...
Class OpenAIQueryHelper
{
    ...
    {
        $directive = 'Rédige une histoire en '. $language .' contenant 3 chapitres de au moins 2 paragraphes de 6 lignes minimum à partir du texte' . $prompt . ' et du teaser :' . $teaserContent . '.';
