...
Class OpenAIQueryHelper
{
    ...
    {
        $directive = 'Rédige une histoire en '. $language .' contenant 1 chapitre de au moins 1 paragraphe de 6 lignes minimum à partir du texte' . $prompt . ' et du teaser :' . $teaserContent . '.';
